...
public class Main {
	...
	public static void main(String[] args) {
		int[] numbersOfElements = new int[]{50, 100, 250, 500, 750, 1000, 1500, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 10000};
		...
		SortingAlgorithm<MarkedValue<Integer>> algorithm = new UnstableSelectionSort<>(markedComparator);
...
//		SortingAlgorithm<MarkedValue<Integer>> algorithm = new ShakerSort<>(markedComparator);
//		RunResult result = Tester.runOnce(algorithm, generator, 10);
	}
