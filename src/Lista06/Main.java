...
import Lista06.QuickSort.FirstElementPivotSelection;
import Lista06.QuickSort.LinkedListOptimizedQuickSort;
import Lista06.QuickSort.QuickSort;
import Lista06.QuickSort.RandomPivotSelection;
...
//        Generator<MarkedValue<Integer>> generator = new MarkingGenerator<Integer>(new ShuffledIntegerArrayGenerator());
        ...
        SortingAlgorithm<MarkedValue<Integer>> algorithm = new LinkedListOptimizedQuickSort<>(markedComparator, new FirstElementPivotSelection());
